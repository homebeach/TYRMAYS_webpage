...
{ include file="maint_header.tpl" header="Add member to board" }

Add {$member[0].first_name} {$member[0].surname} {$member[0].other_names} to board.

<form name="eventForm" action="index.php" method="post">
<input type="hidden" name="action" value="add_to_board"/>
