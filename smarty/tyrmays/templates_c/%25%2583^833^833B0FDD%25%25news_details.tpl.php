<?php /* Smarty version 2.6.26, created on 2010-05-04 13:55:39
         compiled from news_details.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'news_details.tpl', 9, false),)), $this); ?>
...
?>	
    ...
    <tr>
	<td colspan=2><?php echo $this->_tpl_vars['news'][$this->_sections['i']['index']]['newsdescfi']; ?>
</td>
    </tr>
    ...
    <tr>
	<td colspan=2><?php echo $this->_tpl_vars['news'][$this->_sections['i']['index']]['newsdescen']; ?>
</td>
    </tr>
    <?php endif; ?>
    <?php endfor; else: ?>
        ...
        <tr>
            <td colspan="3"><?php echo $this->_config[0]['vars']['nonews']; ?>
</td>
        </tr>
    <?php endif; ?>
</table>
