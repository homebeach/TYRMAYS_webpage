<?php /* Smarty version 2.6.26, created on 2010-05-05 04:43:40
...
<div id="heading"><a> <?php echo $this->_config[0]['vars']['joinmember']; ?>
 </a>  </div>
...
<p>
Provacy policy of membership register can be found <a href="http://www.tyrmays.net/rekisteriseloste_en.txt">here</a>.
</p>
...
<br />	
<input type="password" name="password" value="" maxlength="20" /><span <?php if ($this->_tpl_vars['password'] == error): ?> id="error" <?php endif; ?>><?php if ($this->_tpl_vars['passwordsdonotmatch'] == error): ?><?php echo $this->_config[0]['vars']['passwordsdonotmatch']; ?>
 <?php else: ?> <?php endif; ?>*</span><br />
<?php echo $this->_config[0]['vars']['passwordagain']; ?>
<br />
<input type="password" name="password2" value="" maxlength="20" /><span <?php if ($this->_tpl_vars['password'] == error): ?> id="error" <?php endif; ?>><?php if ($this->_tpl_vars['passwordsdonotmatch'] == error): ?><?php echo $this->_config[0]['vars']['passwordsdonotmatch']; ?>
 <?php else: ?> <?php endif; ?>*</span><br />
<br />
