...
class SQL {
  ...
  function editEvent($request) {
   ...
   $valuearray = array('eventstartdatetime' => $eventstartdatetime, 
			 	 ...
			 	 'eventnameen' => $request['eventNameEn'], 
			  	 ...
			  	 'eventdescriptionfi' => $request['eventDescriptionFi'],
  ...
  function getNonMembers() {
    ...
    $stmt = "SELECT * FROM uno3396.members m, uno3396.major s WHERE m.majorid=s.majorid AND m.membership_paid=0 order by membership_requested desc";

    return $this->db->getAll($stmt); // getAll palauttaa kaikki "sopivana" taulukkona 
  }
  
  function getObsoleteMembers() {

    $stmt = "SELECT * FROM uno3396.members m, uno3396.major s WHERE m.majorid=s.majorid AND m.membership_paid=1 AND DATE_SUB(CURDATE(),INTERVAL 1 YEAR) >= m.membership_last_paid";
  ...
  function getMembers() {
    ...
    $stmt = "SELECT * FROM uno3396.members m, uno3396.major s WHERE m.majorid=s.majorid AND m.membership_paid=1 AND m.membership_paid=1 AND DATE_SUB(CURDATE(),INTERVAL 1 YEAR) <= m.membership_last_paid order by membership_requested desc";
  ...
  function getWebmaster() {
    ...
    $stmt = "SELECT DISTINCT b.studentnumber FROM uno3396.board b, uno3396.officials o WHERE (b.statusen ='Web-developer' OR b.statusen = 'Webmaster' OR o.statusen = 'Web-developer' OR o.statusen = 'Webmaster') AND b.year=(select max(year) from board) AND o.year=(select max(year) from officials)";
  ...
  function removeParticipant($request) {
  ...
  function getParticipants($request) {
	...
	$stmt = "SELECT * FROM uno3396.members m, uno3396.participants p WHERE m.studentnumber=p.studentnumber and p.eventid = ?";
  ...
  function getMinute($request) {
    ...
    $stmt = "SELECT * FROM uno3396.minutes where minuteid = ?";
  ...
  function deleteMinute($request) {
    ...
    $stmt = "DELETE FROM uno3396.minutes WHERE minuteid = ?";
  ...
  function getLink($request) {
    ...
    $stmt = "SELECT * FROM uno3396.links WHERE linkid = ?";
    
    $data = array('linkid' => $request['linkid']);
