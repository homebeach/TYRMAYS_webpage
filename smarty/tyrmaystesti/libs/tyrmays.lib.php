...
//delete link from database
  ...
  function maint_add_minute_form() {
	...
	$this->tpl->assign('firstname',$firstname);
	$this->tpl->assign('surname',$surname);
    $this->tpl->display('maint_add_minute.tpl');
  }
  ...
  function maint_add_minute($request) {
	...
	if(move_uploaded_file($_FILES['minute']['tmp_name'], $target))
	{
		...
		$message = "The file ". basename( $_FILES['uploadedfile']['name']). " has been uploaded, and your information has been added to the directory";
	}
	else {
